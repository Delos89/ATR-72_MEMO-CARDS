...
def main(page: ft.Page):
    ...
    page.scroll = ft.ScrollMode.AUTO  # Fallback page-level scrolling
    ...
    def go_to_start_screen():
        ...
        page.add(
            ft.Column(
                controls=[
                    ft.Text("ATR-72 Flight Deck Trainer", size=30, weight=ft.FontWeight.BOLD, text_align=ft.TextAlign.CENTER),
                    ft.Text("Select a category to start your randomized study session", size=14, color=ft.Colors.GREY_400, text_align=ft.TextAlign.CENTER),
    ...
    def go_to_answer_screen(answer_text):
        ...
        page.add(
            ft.Column(
                controls=[
                    ft.Text(mode_title, size=18, color=ft.Colors.BLUE_200, weight=ft.FontWeight.BOLD),
                    ft.Text("Answer / Action:", size=14, color=ft.Colors.GREY_400),
                    ft.Container(height=10),
                    ft.Container(
                        content=ft.Text(answer_text, size=16, color=ft.Colors.WHITE, weight=ft.FontWeight.W_500, selectable=True),
                        padding=15,
                        border_radius=10,
        ...
        page.add(
            ft.Column(
                controls=[
                    ...
                    ft.Container(height=10),
                    ft.Text("Session Complete!", size=28, weight=ft.FontWeight.BOLD),
                    ft.Text(f"You reviewed all {total_cards} cards in {mode_title}.", size=15, color=ft.Colors.GREY_400, text_align=ft.TextAlign.CENTER),
        ...
        page.add(
            ft.Column(
                controls=[
                    ...
                    ft.Container(height=20),
                    ft.Text(chosen_memo, size=20, weight=ft.FontWeight.BOLD, text_align=ft.TextAlign.CENTER),
